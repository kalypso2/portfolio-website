...
export default function LeftSocialMediaIcons() {
    return (
        <div className="flex flex-col items-center space-y-4">
            ...
            <a href="https://www.linkedin.com/in/samuel-ebaugh-130010233" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            ...
            <a href="https://twitter.com/YOUR-TWITTER" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                <FaTwitter size={30} className="text-gray-800 hover:text-purple-600 transition-transform hover:scale-110" />
            </a>
